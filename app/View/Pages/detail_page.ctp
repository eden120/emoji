<?php echo $this->Html->css(array("reveal","jquery-ui")); ?>
<?php echo $this->Html->script(array("jquery-1.6.min","jquery.reveal")); ?>
<?php echo $this->Html->script(array("jquery-1.10.2","jquery-ui")); ?>
<style>
#ui-datepicker-div {
...
<?php // echo "<pre>"; print_r($this->data['Page']); ?>
<?php echo $this->Form->create('Page',array('action'=>'detail_page','method'=>'POST')); ?>
<h5 style="margin:5px;">
<?php echo $this->Form->input('title',array('type'=>'text','class'=>"input left-margin", 'div'=>false,'label'=>false,'style'=>'margin-left:-5px','value'=>$this->data['Page']['title'])); ?>
<?php //echo $this->data['Page']['title']; ?></h5>
...
<?php echo $this->Form->checkbox('User.lock',array('div'=>false,'label'=>false,'id'=>'lock','hiddenField'=>false)); ?>
</div>

</div>
<?php if(!empty($this->data['Page']['locked_time'])){ ?>
<div class="empty lockmsg">Last Locked: <?php echo date("d/m/Y H:i a", strtotime($this->data['Page']['locked_time'])); ?></div>
<?php }else{ ?>
<div class="empty"></div>
<?php } ?>
...
<div class="page4-div2-BTN1-checkbox">
<?php echo $this->Form->checkbox('User.unlock',array('div'=>false,'label'=>false,'id'=>'unlock','hiddenField'=>false)); ?>
</div>


</div>

<?php if(!empty($this->data['Page']['unlocked_time'])){ ?>
<div class="empty lockmsg">Last Unlocked: <?php echo date("d/m/Y H:i a", strtotime($this->data['Page']['unlocked_time'])); ?></div>
<?php }else{ ?>
<div class="empty"></div>
<?php } ?>
...
<div>
<?php echo $this->Form->input('User.password',array('type'=>'password','class'=>"page4-div2-PASSWORD", 'div'=>false,'label'=>false)); ?>
</div>
...
echo $this->Form->input('date_of_purchase',array('type'=>'text', 'class'=>"input left-margin",'div'=>false,'label'=>false,'id'=>'datepicker','value'=>$date_of_purchase)); ?>
</div>
</div>
...
<div class="right-text-box">
<?php echo $this->Form->input('purchased_from',array('type'=>'text','class'=>"input left-margin", 'div'=>false,'label'=>false)); ?>
</div>
</div>
...
<div class="right-text-box">
<?php echo $this->Form->input('price',array('type'=>'text','class'=>"input left-margin dollar", 'div'=>false,'label'=>false)); ?>
</div>
</div>
...
<div class="right-text-box">
<?php echo $this->Form->input('reason',array('type'=>'text','class'=>"input left-margin", 'div'=>false,'label'=>false)); ?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('sale_value',array('type'=>'text','class'=>"input left-margin dollar",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('sell_it_get',array('type'=>'text','class'=>"input left-margin dollar",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('sell_it_only',array('type'=>'text','class'=>"input left-margin dollar",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('offer_to_relative',array('type'=>'text','class'=>"input left-margin",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('donate',array('type'=>'text','class'=>"input left-margin",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('keep_as_family',array('type'=>'text','class'=>"input left-margin",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div class="right-text-box"> 
<?php echo $this->Form->input('other',array('type'=>'text','class'=>"input left-margin",'div'=>false,'label'=>false));?>
</div>
</div>
...
<div>
<?php echo $this->Form->textarea('comment',array('div'=>false,'label'=>false,'class'=>'commentry-input','style'=>'background:#FFFFFF; border:#1a72a6 solid thin;'));?>
</div>
...
<div class="page4-button-box" style="padding-left:150px;width:900px">
...
<div class="page4-button-div2">
<div class="button-div2">
<dt style="padding-top:25px;"><?php //echo $this->Html->link("SAVE","/pages/list_pages", array('class'=>'link-class')); ?>
<?php echo $this->Form->submit("SAVE",array("class"=>"submitButton","label"=>false,"div"=>false,"style"=>"font-size:30px"));?>
</dt>
</div>
</div>
