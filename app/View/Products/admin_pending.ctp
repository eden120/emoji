...
<?php echo $this->Paginator->sort('User.name','Owner Name');?> </th>
                                  <th><i class="fa fa-cube"></i>
<?php echo $this->Paginator->sort('Product.name','Product Name');?> </th>
							    ...
							    <div class="col-md-9 pull-left">
								  <div id="actions-box">				  
									<div class="btn-group">
									 ...
									 <li><a href="javascript:void(0);" onclick="do_action('Approve','products');">Approve</a></li>
