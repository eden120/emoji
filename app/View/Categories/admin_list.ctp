     ...
     <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
					   <?php echo $this->Form->create('Category',array('action'=>'list','method'=>'POST', "class" => "form-inline", "fname" => "listForm", "id" => "mainform","role"=>"form")); ?>
						  ...
						  echo $this->Form->button("Reset",array('type'=>'button','class'=>"btn btn-warning",'div'=>false,'onclick'=>"location.href='".BASE_URL."admin/categories/list'"));
						  ?>
						  </div>
                     ...
                     <?php echo $this->Form->end(); ?>
					   ...
					   <hr>
						<h4  style="color:red;">Categories Listing</h4>
                          <table class="table table-striped table-advance table-hover">
							  ...
							  <th class="hide-mobile"> <?php echo $this->Paginator->sort('Category.image','Image');?></th>
                              ...
                              <tr>
                                  ...
                                  <td><a href="javascript:void(0);"><?php echo $result['Category']['name']; ?></a></td>
								   <td><a href="javascript:void(0);"> <img src="<?php echo BASE_URL."app/webroot/img/".$result['Category']['image']; ?>" height="60" width="50"></a></td>
