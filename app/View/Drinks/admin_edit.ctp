 <div class="row mt">
				  ...
				  <div class="form-panel">
					  ...
					  <?php echo $this->Form->create('Drink',array('action'=>'edit','method'=>'POST','onsubmit' => '',"class"=>"form-horizontal style-form",'enctype'=>'multipart/form-data')); ?>
					...
					foreach($bars as $k => $v){
     				...
     				$fieldsArray = array('' => 'Select bars','Drink.name'=> 'Drink Name');
				               echo $this->Form->input("Drink.barid",array("type"=>"select","class"=>"form-control","options"=>$newCats,"label"=>false,'required'=>true,"div"=>false));
                ...
                ?> 
				  ...
				  <div class="form-group">
                              ...
                              <div class="col-sm-6">
								  ...
								  <?php
				     echo $this->Form->input("price",array("type"=>"text","class"=>"form-control","label"=>false,"div"=>false, 'required'=>true));
                ?> 
                              </div>
                          </div>
                ...
                ?> 
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-6">
				    			  ...
				    			  <?php
								  echo $this->Form->input('img',array("label"=>false,'type'=>'file','required' => false));
				     ?>
						  ...
						  <div class="form-group">
						    <div class="col-sm-2">
                              ...
                              <div class="col-sm-10">
								...
								echo $this->Form->button('Back',array('type'=>'reset','class'=>"btn btn-theme",'div'=>false,'onclick'=>"location.href='".BASE_URL."admin/drinks/list'")); 
								?>
                              </div>
