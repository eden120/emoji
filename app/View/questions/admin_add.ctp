 <div class="row mt">
				  ...
				  <div class="form-panel">
					  ...
					  <?php echo $this->Form->create('Question',array('action'=>'add','method'=>'POST','onsubmit' => '',"class"=>"form-horizontal style-form")); ?>
                     ...
                     <div class="col-sm-6">                                
					 <?php
				     echo $this->Form->input("ques",array("type"=>"text","class"=>"form-control","label"=>false,"div"=>false ));
                     ?> 
                     </div>
                     </div>
				    ...
				    <div class="form-group">
                     ...
                     <div class="col-sm-6">                          
					 <?php
				     echo $this->Form->input("ans",array("type"=>"text","class"=>"form-control","label"=>false,"div"=>false));
                     ?> 
                     </div>
                     </div>	  
				     <div class="form-group">
